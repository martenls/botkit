...
import { MiddlewareSet, ActivityTypes, ContactRelationUpdateActionTypes } from 'botbuilder';
 ...
 *
 */
export class TwitterEventTypeMiddleware extends MiddlewareSet {
    /**
    ...
    public async onTurn(context, next): Promise<void> {
        ...
        // let type = null;
        // if (context.activity) {
        //     if (context.activity.channelId == 'TwitterDM') {
        //         type = '';
        //     }
        // }
